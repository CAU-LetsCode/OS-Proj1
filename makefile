...
kernel.exe: kernel_c.o kernel_asm.o convert_c.o buddy_c.o
	ld -g -melf_i386 -z noexecstack -Ttext 0x10000 -e main -o kernel.exe kernel_c.o kernel_asm.o convert_c.o buddy_c.o
kernel_c.o: kernel.c
...
clean:
	rm kernel.exe kernel_c.o kernel_asm.o buddy_c.o convert_c.o a.img boot1 boot2
